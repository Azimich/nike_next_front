              ...
              <div className='flex-[1]'>
                ...
                <div className='p-5 my-5 bg-black/[0.05] rounded-xl'>  
                  ...
                  <div className='text-sm md:text-md py-5 border-t mt-5'> 
                    The subtotal reflests the total price of you order, including duties and taxes, before any applicable discounts. It does not include delivery costs and international transaction feec.
                  </div>
                </div>
                <button onClick={handlePayment} className="flex gap-3 justify-center w-full py-4 rounded-full bg-black text-white text-lg font-medium transition-transform active:scale-95 mb-3 hover:opacity-75">
                  Checkout
                  {loading && <img src='/spinner.svg' alt='ttt'/>}
                </button>
              </div>
            </div>
            {/* CART CONTENT END */}
