      ...
      <Wrapper className='h-[60px] flex items-center justify-between'>
        ...
        <div className='flex items-center gap-2 text-black'>
          <div className='w-8 md:w-12 h-8 md:h-12 rounded-full flex justify-center items-center hover:bg-black/[0.05] cursor-pointer relative'>
            ...
            <span className='h-[14px] md:h-[18px] min-w-[14px] rounded-full md:min-w-[18px] absolute top-1 left-5 flex justify-center text-white bg-red-600 text-[10px] md:text-[12px] px-[2px] md:px-[5px]'>
              5
            </span>
          </div>
        </div>
